...
mlflow.set_tracking_uri(
    "https://dagshub.com/shivamtiwari83032-collab/mini-mlops-proj.mlflow"
)
dagshub.init(
    repo_owner="shivamtiwari83032-collab", repo_name="mini-mlops-proj", mlflow=True
)
...
with mlflow.start_run():
    ...
    import os
    # Create a local directory to save the model first
    model_dir = "temp_model_files"
    ...
    try:
        ...
        mlflow.log_artifacts(model_dir, artifact_path="model_folder")
        
        # This registers it in the Models tab as you did before
        mlflow.sklearn.log_model(best_model, artifact_path="model", registered_model_name="LogisticRegressionTweetModel")
        
        print("✅ SUCCESS: Folder and Model registered!")
    except Exception as e:
        print(f"❌ Upload failed: {e}")

    # Log your script as usual
